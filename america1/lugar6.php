...
<div id="fixa">
<table >
<img  align="left" src="Amfoto23.jpg" width="330" height="280px"><br>
<img  align="left" src="Amfoto24.jpg" width="330" height="280px">
</table>
</div>
</td> 
...
<font size=6><br>
<center>Whistler</center>
</font>
<br><br><br>
<font size=5 >
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Whistler é considerada um dos melhores destinos de inverno na América do Norte justamente por ser tambem uma das melhores estações de esqui do mundo. A estação dispõe de infra-estrutura excelente para os que ainda estão iniciando a se aventurar nos esportes de inverno, com escolas de esqui e outras atividades na neve para iniciantes.<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;O vilarejo conta com vários hotéis de luxo, chalés e outras opçoes de hospedagem, além de ser rodeado de restaurantes, lojas e até baladas para os mais empolgados. A cidade ainda conta com atividades indoor como spas e sessões de cinema.  <br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Em whistler é possivel praticar diferentes esportes na neve, como a tirolesa de inverno, trenós de cachorros, escalada no gelo, patinação, bangee jumping e snowboard. <br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;A cidade ainda oferece opções de passeis diferente dos convencionais como passeios de helicóptero com voos panorâmicos até as geleiras da região. De cima é possivel ter uma vista espetacular da cachoeira Brandywine Falls, que no inverno fica ianda mais especial.
<br><br>
</font>
<fonte size=3>fonte : https://voesimples.com.br/destinos-viagens/melhores-destinos-inverno-america-norte-2016-2017/</fonte>
<br><br>
<font size=4>
COMENTÁRIOS<br>
...
<input type="hidden" name="identificacao" value="Amlugar6">
...
$sql ="SELECT * FROM comentario_site WHERE identificacao = 'Amlugar6' ORDER BY id desc";
...
<div id="fixa">
<table>
<img  align="right" src="Amfoto22.jpg" width="360" height="280px">
<img  align="right" src="Amfoto21.jpg" width="360" height="280px">
