	...
	<td width="100%" colspan="3">
		...
		<tr >
			...
			<!-- TAG DA PAGINA--><td align="center" width="2%" ><font size="7" color="white"> <a href="index.php" class="botao" style="text-decoration:none;color:#ffffff"> SUJESTS </font></td>
			 <td align="center" width="16%"> <a href="contato1.php" style="text-decoration:none;color:#FF0000">CONTATO</a>  </td>
		</tr>
		<tr></tr>
...
<p style="font-size:4em;">ENTRE EM CONTATO COMIGO!</p>
<font size="4">
&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp; &nbsp;&nbsp;NOME: Gabriel Nicholas Pires de Moraes <br>
&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp; &nbsp;&nbsp;E-MAIL: gabrielnpmoraes@hotmail.com    <br>
IDADE: 17 anos  &nbsp;&nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp; &nbsp;&nbsp;                       <br>
TELEFONE: (34)99227-4079 &nbsp;&nbsp;&nbsp;&nbsp;              <br>
