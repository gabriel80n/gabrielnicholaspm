...
<div id="fixa">
<table >
<img  align="left" src="foto23.jpg" width="330" height="280px"><br>
<img  align="left" src="foto24.jpg" width="330" height="280px">
</table>
</div>
</td> 
...
<font size=6><br>
<center>Grotta Palazzese</center>
</font>
<br><br><br>
<font size=5 >
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Localizado na Itália, a vista desse restaurante do Mar Adriático é estonteante. Principalmente no verão (na Europa). É nessa estação que o hotel Grotta Palazzese fica ainda mais encantador. Os especialistas afirmam que um jantar no local é uma experiência única - como poucas no mundo. <br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;O restaurante do século XVIII fica a cerca de 20 metros do nível do mar. O menu até que não é caro para tanta beleza: 100 dólares por pessoa. O Grotta Palazzese fica aberto de maio a outubro. Excelente apetite! <br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Estar na Itália, com uma vista de frente para o mar Adriático já é incrível. Mas o restaurante do hotel Grotta Palazzese tornou essa experiência ainda mais especial: ele foi construído dentro de uma gruta natural, em Polignano a Mare, cidadezinha na região de Puglia, conhecida como o “calcanhar” da bota do mapa italiano.<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Com características medievais, uma parte da cidade fica sobre um complexo rochoso voltado para as águas azuis do mar Adriático, em falésias calcárias. É ali que se pode desfrutar da paisagem e ainda degustar a típica comida italiana no restaurante. O salão tem aproximadamente 30 metros de diâmetro, de onde se tem uma vista sensacional por meio da abertura natural na rocha.
<br><br>
</font>
<fonte size=3>http://www.gazetadopovo.com.br/haus/estilo-cultura/restaurante-em-gruta-na-italia-tem-vista-deslumbrante-para-o-mar/</fonte>
<br><br>
<font size=4>
COMENTÁRIOS<br>
...
<input type="hidden" name="identificacao" value="Elugar6">
</form>
<?php

$usuario1 = $_SESSION['usuario'];

$sql ="SELECT * FROM comentario_site WHERE identificacao = 'Elugar6' ORDER BY id desc";
...
<div id="fixa">
<table>
<img  valign="right" src="foto22.jpg" width="360" height="280px">
<img  align="right" src="foto21.jpg" width="360" height="280px">
