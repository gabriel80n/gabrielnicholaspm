...
<div id="fixa">
<table >
<img  align="left" src="Ofoto23.jpg" width="330" height="280px"><br>
<img  align="left" src="Ofoto24.jpg" width="330" height="280px">
</table>
</div>
</td> 
...
<font size=6><br>
<center>Whitehaven</center>
</font>
<br><br><br>
<font size=5 >
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Se você consultar qualquer lista de praias mais lindas do mundo, com certeza verá fotos de Whitehaven Beach, na Austrália. Localizada em Whitsunday Island, ela é parte do famoso arquipélago das Whitsundays, composto por 74 ilhas que flutuam entre a costa nordeste de Queensland e a Grande Barreira de Corais. Os sete quilômetros de areias completamente brancas de Whitehaven repousam entre a vegetação tropical e o mar azul turquesa. Além disso, Whitehaven abriga um dos lugares mais fotografados da Austrália: a enseada de Hill Inlet. Conforme a maré sobe ou desce, a areia é deslocada pela água cristalina, criando uma fusão de branco, verde e azul que lembra uma pintura!<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Só existem duas maneiras de chegar a Whitehaven, que é uma área de preservação ambiental: de barco ou de hidroavião. Os passeios nas alturas são mais caros, é claro, mas não tanto que não valham ter uma visão aérea deste lugar sensacional. Além do sobrevoo cênico, você terá direito a duas horas de piquenique na praia regado a uma garrafa de champanhe. Tudo isso pela bagatela de US$ 215 <br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Ir do Brasil até as Whitsundays pode ser uma jornada longa, mas que fica bastante simples quando já se está em uma viagem pela Austrália. A cidade-base mais comum e barata para fazer o passeio é Airlie Beach, onde se pode chegar de ônibus vindos de diversas outras cidades da costa leste australiana ou de avião. Quem quiser voar vai precisar de um pouco mais de planejamento logístico <br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;A areia é 98% composta de pura sílica, elemento que lhe confere a cor inigualável e que não retém calor. Isso quer dizer que você poderá fazer longas caminhadas pela praia sem sequer esquentar os pés. Fora isso, não existe muito o que fazer em Whitehaven, já que não há qualquer tipo de comércio ou habitação em uma área de preservação ambiental (ou seja, leve comida, água e protetor solar com você, porque não vai ter onde comprar!). Aproveite para nadar, tomar banho de sol e relaxar admirando toda a beleza desse lugar incrível!
<br><br>
</font>
<fonte size=3>fonte : http://www.escolhaviajar.com/como-visitar-whitehaven/</fonte>
<br><br>
<font size=4>
COMENTÁRIOS<br>
...
<input type="hidden" name="identificacao" value="Olugar6">
...
$sql ="SELECT * FROM comentario_site WHERE identificacao = 'Olugar6' ORDER BY id desc";
...
<div id="fixa">
<table>
<img  align="right" src="Ofoto22.jpg" width="360" height="280px">
<img  align="right" src="Ofoto21.jpg" width="360" height="280px">
