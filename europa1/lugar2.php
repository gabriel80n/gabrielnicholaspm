...
<div id="fixa">
<table>
<img  align="left" src="foto5.jpg" width="330" height="280px"><br>
<img  align="left" src="foto6.jpg" width="330" height="280px">
</table>
</div>
</td> 
...
<font size=6><br>
<center>Zakynthos</center>
</font>
<br><br><br>
<font size=5 >
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Localizado na Grécia, temos uma das lindas ilhas  que se situa no mar Jônico. Este com certeza é um lugar para se acrescentar a sua lista de destino dos sonhos! Ela possui uma belíssima praia chamada de Navagio(naufrágio), devido à sua descoberta apartir de uma perseguição das autoridades da Grécia com um navio escocês por suspeita de contrabando de cigarros e bebidas que acabou naufragando. Este návio ainda se encontra entre as areias da praia. <br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Para se chegar à essa praia, é necessario pegar um barco no porto Agios Nikolaos. O trajeto até ela ja vale a viagem, pois passa pelas cavernas azuis, um lugar impressionante onde os barcos param para os turistas darem um mergulho nestas águas cristalinas com um tom de azul incrível. <br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Além da curtição na água, tambem existe a possibilidade de se praticar o Base jump, que é uma modalidade na qual o base-jumper salta de penhascos, prédios, antenas e até pontes. Para esse tipo de atividade, faz-se o uso de um pára-quedas apropriado para aberturas a baixas altitudes.<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;E ao final um pôr do sol é sempre um programa delicioso, afinal um nunca é igual ao outro! Cada uma tem sua própria magia!
<br><br>
</font>
<fonte size=3>fonte : https://www.fuiserviajante.com/destinos-no-mundo/grecia/zakynthos/navagio-beach/ </fonte>
</font>
<br><br>
<font size=4>
COMENTÁRIOS<br>
...
<input type="hidden" name="identificacao" value="Elugar2">
</form>
<?php

$usuario1 = $_SESSION['usuario'];

$sql ="SELECT * FROM comentario_site WHERE identificacao = 'Elugar2' ORDER BY id desc";
...
<div id="fixa">
<table>
<img  align="right" src="foto7.jpg" width="360" height="280px">
<img  align="right" src="foto8.jpg" width="360" height="280px">
