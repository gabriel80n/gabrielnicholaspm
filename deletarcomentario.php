...
$id = $_REQUEST['id'];
$sql ="SELECT comentario FROM comentario_site WHERE id = '$id'";
...
$apagar = "DELETE FROM comentario_site WHERE id=$id";	
mysql_query($apagar);
...
<tr>	
 ...
 <tr>	
		<td width="20%" bgcolor="#C0C0C0" align="center" valign="top" bgcolor="#C0C0C0" cellspacing="0">
			<form id="form_nova" name="form_nova" method="post" action= "">


				<table width="50%" height="300px" border="0">
					
					<tr>
						<td colspan="3" align="left"><p style="font-size:2em; "> Alteração de comentario: <?php echo $usuario; ?></p><hr>
							Digite o ID do comentario:
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					...
					<tr height="70">
						<td></td>
						<td align="center"><input class="botao" type="submit" name="deletar" value="Deletar"><br><input type="submit" class="botao" name="voltar" id="button" value="Voltar" onclick="history.go(-1)" /></td>
