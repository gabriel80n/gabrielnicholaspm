...
<div id="fixa">
<table>
<img  align="left" src="Amfoto5.jpg" width="330" height="280px"><br>
<img  align="left" src="Amfoto6.jpg" width="330" height="280px">
</table>
</div>
</td> 
...
<font size=6><br>
<center>Cavernas de Mármore</center>
</font>
<br><br><br>
<font size=5 >
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Entre tantas belezas naturais que existem na Patagônia, as Cavernas de Mármore se destacam pela sua mescla de cores que variam do branco, azul claro ao rosa. Situadas no lago General Carrera, as Capelas de Mármore, como são conhecidas, são um conjunto de túneis criados dentro de uma enorme pedreira. Com cerca de 980 quilômetros quadrados de superfície e mais de 200 quilômetros de extensão, o local é o maior lago chileno.  <br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Localizado na divisa do Chile com a Argentina, o Lago possui um nome em cada país. Em território argentino, ele é conhecido como "Buenos Aires" e no Chile, como "General Carrera". Se não fosse a temperatura média de 9ºC, as suas águas azuis turquesa poderiam ser confundidas com o mar do Caribe. Considerado o lago mais fundo da América do Sul, com até 590 metros de profundidade, suas águas são de origem glacial, daí a explicação para um azul tão intenso. Cercado pelas Cordilheiras dos Andes, a paisagem que já era linda se transforma em paradisíaca. <br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Localizado a cerca de cinco horas (ao sul) de carro da cidade de Coyhaique, o General Carrera é acessível através da Rodovia Austral, pelo Chile. Já na Argentina, o acesso ao "Lago Buenos Aires" é feito pela Província de Santa Cruz, na região da Patagônia. A capital local é a cidade de Rio Gallegos, de onde saí a estrada rumo ao Lago.<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;As belas cavernas de mármore se formaram ao longo de 12 mil anos e foram esculpidas pela erosão das águas e do vento na região. Dependendo da intensidade de ambos dentro de cada túnel, a sua cor e aparência se modificam. Quanto mais estiver exposta aos dois fatores, mais lisa e colorida será sua superfície. Para visitá-las só é possível através de guias turísticos autorizados e que possuam todos os equipamentos de segurança para a travessia do lago. Os passeios saem de ambas as margens e custam em média R$ 35 por pessoa.
<br><br>
</font>
<fonte size=3>fonte : http://ecoviagem.uol.com.br/noticias/turismo/turismo-internacional/conheca-as-capelas-de-marmore-que-ficam-no-lago-general-carrera-na-patagonia-veja-fotos-17960.asp</fonte>
</font>
<br><br>
<font size=4>
COMENTÁRIOS<br>
...
<input type="hidden" name="identificacao" value="Amlugar2">
...
$sql ="SELECT * FROM comentario_site WHERE identificacao = 'Amlugar2' ORDER BY id desc";
...
if ($row > 0) {
	...
	$data=$record4['data'];
				...
				if (($op == 11)&&(isset($_REQUEST['deletar_comentario']))) {
					...
					echo "<br /><hr>";
				echo "<table width=\"100%\" border=\"0\"> <tr><td width=\"20%\" valign=\"top\" >".$usuario.":<br><br>ID:".$id."<br><br>".$data."</td>";
				echo "<td width=\"200\" > <textarea disabled=\"disabled\" rows=\"7\" cols=\"60\" maxlength=\"540\">".$comentario." </textarea></td><tr><td></td><td>";
				echo "</tr></td></tr></table>";
...
<div id="fixa">
<table>
<img  align="right" src="Amfoto7.jpg" width="360" height="280px">
<img  align="right" src="Amfoto8.jpg" width="360" height="280px">
