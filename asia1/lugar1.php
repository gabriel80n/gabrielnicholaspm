...
<div id="fixa">
<table>
<img  align="left" src="Asfoto4.jpg" width="330" height="280px"><br>
<img  align="left" src="Asfoto3.jpg" width="330" height="280px">
</table>
</div>
</td> 
...
<font size=6><br>
<center>Capadócia</center>
</font>
<br><br><br>
<font size=5 >
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;A Capadócia é uma região da Turquia com belezas naturais e históricas. A área é composta por diferentes cidades e vilas, entre elas Göreme, Ürgüp, Uçhisar e Avanos. Mais do que uma viagem para admirar paisagens estonteantes e voar pelo céu em um balão colorido, que já seriam motivos suficientes para justificar o sucesso do turismo local, a região reserva aos seus visitantes uma imersão na cultura turca－moderna e antiga－e muito aprendizado!   <br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;É inquestionável que a Capadócia tem uma beleza singular. Sua paisagem é formada por vales coloridos, dobraduras e interessantes formações, conhecidas como Chaminés de Fada. A explicação para seu relevo acidentado e muito diferente de outras paisagens mundo afora é que a área é de origem vulcânica e a combinação da erupção de alguns vulcões－que expeliram lava－com a ação erosiva de rios modelaram a paisagem local de forma a criar as diferentes formações e os vales que hoje conhecemos.<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Quem nunca viu uma fotografia do céu azul da Capadócia cheio de balões sobrevoando sua zona rochosa e não imaginou fazer um voo por lá também? Difícil resistir a esse desejo. Essa é uma das principais atividades para se fazer na Capadócia e é realmente uma experiência inesquecível, algo único na vida! No verão, são dezenas de balões coloridos no céu e poder ver o sol nascer lá do alto, com um lugar tão lindo debaixo dos pés é indescritível. O voo de balão é extraordinário e imperdível! <br>

&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;A maioria das pessoas passa a conhecer a Capadócia por causa de sua natureza, e o que muitos não sabem é que o lado cultural e histórico é tão interessante quanto sua beleza. Passeando pela região, é de impressionar a quantidade de cavernas que existem, a quantidade de igrejas seculares com pinturas sagradas, muitas delas no Göreme Open Air Museum, castelos, como o Castelo de Uçhisar, e até a existência de cidades subterrâneas! Derinkuyu é uma cidade embaixo da terra que tem 85 m de profundidade e uma de suas finalidades foi oferecer proteção aos cristãos que sofriam perseguição religiosa. 
<br><br>
</font>
<fonte size=3>fonte : https://guia.melhoresdestinos.com.br/capadocia-183-c.html</fonte>
<br><br>
<font size=4>
COMENTÁRIOS<br>
...
<input type="hidden" name="identificacao" value="Aslugar1">
...
$sql ="SELECT * FROM comentario_site WHERE identificacao = 'Aslugar1' ORDER BY id desc";
...
<div id="fixa">
<table>
<img  align="right" src="Asfoto1.jpg" width="360" height="280px">
<img  align="right" src="Asfoto2.jpg" width="360" height="280px">
