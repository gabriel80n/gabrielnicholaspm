...
--
-- Host: 127.0.0.1
-- Generation Time: 04-Dez-2017 às 02:51
...
INSERT INTO `cad_usuario` (`ID`, `usuario`, `senha`, `email`) VALUES
(17, 'gabriel80n', '12345678', 'gabrielnpmoraes@hotmail.com');
...
CREATE TABLE `comentario_site` (
  `ID` int(11) NOT NULL,
  `comentario_escrito` varchar(140) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
